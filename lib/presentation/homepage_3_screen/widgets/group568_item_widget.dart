...
class Group568ItemWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      onTap: () {
        Navigator.pushNamed(context, JobDetails1Screen.id, arguments: job);
      },
      child: Padding(
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  Text(
                                    ...
                                    "${Constants.currency}${job?.salaryMax ?? ""}/${job!.salaryType!.substring(0, 1)}",
                                    overflow: TextOverflow.ellipsis,
                    ...
                    children: [
                      Padding(
                        ...
                        child: Container(
                          ...
                          child: Image.network(
                            job != null && job!.thumbnailImage != null
                                ? job!.thumbnailImage!
                                : "https://whitejobs.co.in/images/avatar.png",
                            fit: BoxFit.fill,
                          ),
