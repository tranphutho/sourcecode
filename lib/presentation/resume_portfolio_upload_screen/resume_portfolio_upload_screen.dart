...
class ResumePortfolioUploadScreen extends StatefulWidget {
  ...
  @override
  State<ResumePortfolioUploadScreen> createState() =>
      _ResumePortfolioUploadScreenState();
}

class _ResumePortfolioUploadScreenState
    extends State<ResumePortfolioUploadScreen> {
  bool upload = true;
