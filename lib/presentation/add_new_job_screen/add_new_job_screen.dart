...
class _AddNewJobScreenState extends State<AddNewJobScreen> {
  ...
  String applyTypeDWValue = "Send email";
  ...
  List<DropdownMenuItem<dynamic>>? publishList = [
    DropdownMenuItem(
  ...
  List<DropdownMenuItem<dynamic>>? jobTypeList = [
    DropdownMenuItem(
      child: Text("Full Time", style: TextStyle(color: Colors.black),),
      value: "Full Time",
    ),
    DropdownMenuItem(
        child: Text("Part Time", style: TextStyle(color: Colors.black),),
        value: "Part Time"
    ),
    DropdownMenuItem(
      child: Text("Contract", style: TextStyle(color: Colors.black),),
      value: "Contract",
    ),
    DropdownMenuItem(
      child: Text("Freelance", style: TextStyle(color: Colors.black),),
      value: "Freelance",
    ),
    DropdownMenuItem(
      child: Text("Internship", style: TextStyle(color: Colors.black),),
      value: "Internship",
    ),
    DropdownMenuItem(
      child: Text("Temporary", style: TextStyle(color: Colors.black),),
      value: "Temporary",
    )
  ];

  List<DropdownMenuItem<dynamic>>? applyTypeList = [
    DropdownMenuItem(
      child: Text("Send email", style: TextStyle(color: Colors.black),),
      value: "Send email",
    ),
    DropdownMenuItem(
        child: Text("Default", style: TextStyle(color: Colors.black),),
        value: "Default"
    ),
    DropdownMenuItem(
      child: Text("External", style: TextStyle(color: Colors.black),),
      value: "External",
    ),
  ];
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Align(
                        alignment: Alignment.topLeft,
                        child: Text("Hours", style: TextStyle(fontSize: 14, fontWeight: FontWeight.bold),)
                    ),
                    SizedBox(height: 10,),
                    Row(
                      children: [
                              ...
                              child:Padding(
                                  ...
                                  child:DropdownButton(
                                    ...
                                    items: [ //add items in the dropdown
                                      DropdownMenuItem(
                                        child: Text("/day", style: TextStyle(color: Colors.black, fontSize: 14),),
                                        value: "/day",
                                      ),
                                      DropdownMenuItem(
                                          child: Text("/week", style: TextStyle(color: Colors.black, fontSize: 14),),
                                          value: "/week"
                                      ),
                                      DropdownMenuItem(
                                        child: Text("/month", style: TextStyle(color: Colors.black, fontSize: 14),),
                                        value: "/month",
                                      ),
                                      DropdownMenuItem(
                                        child: Text("/year", style: TextStyle(color: Colors.black, fontSize: 14),),
                                        value: "/year",
                                      ),
                                    ],
                      ...
                      children: [
                        Column(
                          ...
                          children: [
                            Align(
                                alignment: Alignment.topLeft,
                                child: Text("Expiration date", style: TextStyle(fontSize: 14, fontWeight: FontWeight.bold),)
                            ),
                            SizedBox(height: 10,),
                            SizedBox(
                              height: 50,
                              ...
                              child: TextField(
                                ...
                                controller: txtExpirationDate, //editing controller of this TextField
                                ...
                                onTap: () async {
                                  ...
                                  if(pickedDate != null ){
                                    ...
                                    setState(() {
                                      txtExpirationDate.text = formattedDate; //set output date to TextField value.
                                    });
                                  }else{
                    ...
                    Align(
                        alignment: Alignment.topLeft,
                        child: Text("Salary", style: TextStyle(fontSize: 14, fontWeight: FontWeight.bold),)
                    ),
                    SizedBox(height: 10,),
                    Row(
                      children: [
